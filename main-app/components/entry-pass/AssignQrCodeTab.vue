<template>
  <v-col cols="12">
    <base-table
      ...
      :headers="headers"
      :itemPerPage="10"
      :pageRange="pageRangeQrCode"
      :page="pageQrCode"
      :pages="pages"
      :isLoading="isAccessCardLoading"
      noDataMsg="You don't have any QR code access yet."
      noDataImg="/empty.svg"
      :elevation="0"
    >
                  ...
                  <v-row no-gutters>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <v-avatar
                            v-if="item.raw.fullName"
                            size="small"
                            :color="stringToColor(item.raw.fullName)"
                            class="mr-2"
                          >
                            {{ getInitial(item.raw.fullName) }}
                          </v-avatar>
                          {{ item.raw.fullName || "--" }}
                        </span>
                      </v-row>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {{
                            item.raw.dateOfJoin
                              ? standardFormatDate(item.raw.dateOfJoin)
                              : "--"
                          }}
                        </span>
                      </v-row>
...
const emit = defineEmits(["addQRCodeAccess"]);
